...
public class TokenBlockingPairsReducer extends MapReduceBase implements Reducer<Text, VIntArrayWritable, Text, Text> {
	...
	public void reduce(Text _key, Iterator<VIntArrayWritable> values,
		...
		while (values.hasNext()) {
			...
			//VIntWritable dID1 = e1[0]; //FIXME:clean-clean ER
			...
			for (VIntWritable[] e2 : buf) {			
				...
				reporter.progress();
				//if (!e2[0].equals(dID1)){ //FIXME:clean-clean ER
